<template>
  <!--我 组件-->
  <div id="self" v-title data-title="微信">
      ...
      <div class="weui-cells-a">
        <router-link to="/self/profile" class="weui-cell weui-cell_access">
          <div class="weui-cell__hd">
            <img src="../../assets/images/weixin-tou.png" alt="" class="self-header">
          </div>
          <div class="weui-cell__bd">
            <h4 class="self-nickname">胡八一</h4>

            <p class="self-wxid">微信号: hsy1906462480</p>
          </div>
       ...
       <div class="weui-cells">
        <router-link to="/self/album" class="weui-cell weui-cell_access">
          <div class="weui-cell__hd">
            <img src="../../assets/images/me_more-zhifu.png">
          </div>
          <div class="weui-cell__bd">
            <p>支付</p>
          </div>
